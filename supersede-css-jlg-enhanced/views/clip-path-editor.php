        ...
        <div class="ssc-pane">
            <div class="ssc-stack">
                ...
                <div class="ssc-form-field">
                    <label class="ssc-form-label" for="ssc-clip-preset"><?php esc_html_e('Sélectionner une forme', 'supersede-css-jlg'); ?></label>
                ...
                <div class="ssc-form-field">
                    <div class="ssc-form-label-row">
                        <label class="ssc-form-label" for="ssc-clip-preview-size"><?php esc_html_e("Taille de l'aperçu", 'supersede-css-jlg'); ?></label>
                        <span class="ssc-form-label-meta" id="ssc-clip-size-val"><?php echo esc_html__('300px', 'supersede-css-jlg'); ?></span>
                    </div>
                    <input type="range" id="ssc-clip-preview-size" min="100" max="500" value="300" step="10">
                </div>
                ...
                <div class="ssc-form-actions">
                    <button id="ssc-clip-copy" class="button" type="button"><?php esc_html_e('Copier le CSS', 'supersede-css-jlg'); ?></button>
                </div>
            </div>
        </div>
        <div class="ssc-pane">
            <div class="ssc-stack">
                ...
                <div id="ssc-clip-preview-wrapper" class="ssc-preview-surface ssc-preview-surface--grid">
                    <div id="ssc-clip-preview" class="ssc-clip-preview" style="background-image: url('<?php echo esc_url($preview_background); ?>');"></div>
                </div>
            </div>
        </div>
    </div>
