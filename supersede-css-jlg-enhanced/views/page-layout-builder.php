...
<div class="ssc-app ssc-fullwidth">
    ...
    <div class="ssc-panel ssc-tutorial-panel" style="margin-bottom:16px;">
        ...
        <ol>
            ...
            <li><?php printf(wp_kses_post(__('Allez dans le menu %1$s, collez le code dans l\'éditeur (onglet Desktop) et cliquez sur %2$s.', 'supersede-css-jlg')), '<strong>Supersede CSS → Utilities</strong>', '<strong>"Save CSS"</strong>'); ?></li>
        </ol>
        ...
        <ol>
            ...
            <li><?php printf(wp_kses_post(__('Ajoutez un bloc %s. Ce sera votre conteneur principal.', 'supersede-css-jlg')), '<strong>Groupe</strong>'); ?></li>
            <li><?php printf(wp_kses_post(__('Sélectionnez ce bloc Groupe, allez dans le panneau des réglages à droite, section %s.', 'supersede-css-jlg')), '<strong>"Avancé"</strong>'); ?></li>
            <li><?php printf(wp_kses_post(__('Dans le champ "Classe(s) CSS additionnelle(s)", collez la classe principale du layout (par exemple, %s).', 'supersede-css-jlg')), '<code>ssc-layout-holy-grail</code>'); ?></li>
            ...
            <li><?php printf(wp_kses_post(__('Pour chaque bloc intérieur, assignez la classe CSS de sa zone dans ses réglages "Avancé" (%1$s, %2$s, %3$s, etc.).', 'supersede-css-jlg')), '<code>header</code>', '<code>content</code>', '<code>footer</code>'); ?></li>
  ...
  /* ... autres propriétés ... */
        ...
        <p><?php printf(wp_kses_post(__('Pour une maintenance facile, définissez vos espacements ou tailles de colonnes avec des %1$s. Par exemple :', 'supersede-css-jlg')), '<a href="' . esc_url($tokens_page_url) . '">' . esc_html__('Tokens', 'supersede-css-jlg') . '</a>'); ?></p>
...
.ssc-layout-sidebar-right {
  ...
  gap: var(--spacing-medium);
        ...
        <p><?php printf(wp_kses_post(__('Utilisez les modèles générés comme base. En modifiant les valeurs de %1$s et %2$s, vous pouvez inventer n\'importe quelle mise en page imaginable !', 'supersede-css-jlg')), '<code>grid-template-areas</code>', '<code>grid-template-columns</code>'); ?></p>
    </div>
</div>
